...
describe("Home page (integration with Hero via HomepageLayout)", () => {
  it("renders the Hero as the first screen of the homepage", async () => {
    render(await Home());
...
describe("Home page region slots (homepage-shell)", () => {
  it("renders 5 regions in document order", async () => {
  ...
  it("does not render ai-launcher region in page", async () => {
    const { container } = render(await Home());
